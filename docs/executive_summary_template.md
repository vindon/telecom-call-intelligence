...
- **Model:** Gemini 2.5 Flash Lite (Google AI Studio) — ExtractionAgent at temp=0.1, InsightsAgent at temp=0.3
...
*Generated by Telecom Call Intelligence v3.0 — [github.com/vindon/telecom-call-intelligence](https://github.com/vindon/telecom-call-intelligence)*
