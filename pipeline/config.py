...
# Langfuse LLM tracing (pipeline/tracing.py) is enabled by presence of
# LANGFUSE_PUBLIC_KEY/LANGFUSE_SECRET_KEY, not a constant here — same
# optional-key pattern as NVIDIA_API_KEY. See .env.example.
